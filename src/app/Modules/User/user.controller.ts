...
const updateUser = catchAsync(
  async (req: IAuthRequest, res: Response): Promise<void> => {
    ...
    const user = await UserService.updateUser(userId as string, updates);
...
const changeUserStatus = catchAsync(
  async (req: IAuthRequest, res: Response): Promise<void> => {
    ...
    const user = await UserService.changeUserStatus(id as string, status as UserStatus);
...
const changeUserRole = catchAsync(
  async (req: IAuthRequest, res: Response): Promise<void> => {
    ...
    const user = await UserService.changeUserRole(id as string, role as UserRole);
